...
import com.senla.rakickaya.courseplanner.dataExchange.RequestExtractor;
import com.senla.rakickaya.courseplanner.dataExchange.ResponseBuilder;
...
public class Facade implements IFacade {
	...
	public IResponse getSortedCoursesByStartDate() {
		...
		return responseBuilder.build(mCoursesService.getSortedList(SortColumnCourse.START_DATE),
	...
	public IResponse getCoursesWithLectures() {
		ResponseBuilder responseBuilder = new ResponseBuilder();
		return responseBuilder.build(mCoursesService.getCoursesWithLectures(), Messages.LIST_IS_EMPTY);
	}

	@Override
	public IResponse getSortedCoursesByCountStudents() {
		ResponseBuilder responseBuilder = new ResponseBuilder();
		return responseBuilder.build(mCoursesService.getCoursesSortedByCountStudent(), Messages.LIST_IS_EMPTY);
	}

	@Override
	public IResponse getSortedCoursesByLectorName() {
		ResponseBuilder responseBuilder = new ResponseBuilder();
		return responseBuilder.build(mCoursesService.getCoursesWithLector(), Messages.LIST_IS_EMPTY);
	}

	@Override
	public IResponse getSortedCoursesByAlphabet() {
		ResponseBuilder responseBuilder = new ResponseBuilder();
		return responseBuilder.build(mCoursesService.getSortedList(SortColumnCourse.NAME_COURSE),
				Messages.LIST_IS_EMPTY);
	}
	...
	public IResponse getSortedLectorsByAlphabet() {
		ResponseBuilder responseBuilder = new ResponseBuilder();
		return responseBuilder.build(mLectorsService.getSortedList(SortColumnLector.NAME_LECTOR),
				Messages.LIST_IS_EMPTY);
	}
	...
	public IResponse getSortedTimeTableByDate() {
		ResponseBuilder responseBuilder = new ResponseBuilder();
		return responseBuilder.build(mTimeTableService.getSortedList(SortColumnLesson.DATE), Messages.LIST_IS_EMPTY);
	}

	@Override
	public IResponse getSortedTimeTableByAlphabet() {
		ResponseBuilder responseBuilder = new ResponseBuilder();
		return responseBuilder.build(mTimeTableService.getSortedList(SortColumnLesson.LECTURE_NAME),
				Messages.LIST_IS_EMPTY);
	}
	...
	public IResponse getSortedCoursesByStartDate(IRequest afterDate) {
		...
		ResponseBuilder responseBuilder = new ResponseBuilder();
		try {
			return responseBuilder.build(mCoursesService.getCoursesWithLectorAfterDate(requestExtractor.extractDate(),
					SortColumnCourse.START_DATE), Messages.LIST_IS_EMPTY);
	...
	public IResponse getSortedCoursesByCountStudents(IRequest afterDate) {
		...
		try {
			return responseBuilder.build(
					mCoursesService.getCoursesAfterDateWithStudents(requestExtractor.extractDate()),
					Messages.LIST_IS_EMPTY);
		} catch (ParseException e) {
	...
	public IResponse getSortedCoursesByLectorName(IRequest afterDate) {
		...
		try {
			return responseBuilder.build(mCoursesService.getCoursesWithLectorAfterDate(requestExtractor.extractDate(),
					SortColumnCourse.LECTOR_NAME), Messages.LIST_IS_EMPTY);
		} catch (ParseException e) {
			logger.error(e.getMessage());
		}
		return responseBuilder.build(Messages.BAD_REQUEST);
	...
	public IResponse getSortedCoursesByAlphabet(IRequest afterDate) {
		...
		try {
			return responseBuilder.build(mCoursesService.getCoursesWithLectorAfterDate(requestExtractor.extractDate(),
					SortColumnCourse.NAME_COURSE), Messages.LIST_IS_EMPTY);
		} catch (ParseException e) {
			logger.error(e.getMessage());
		}
		return responseBuilder.build(Messages.BAD_REQUEST);
	...
	public IResponse getSortedCurrentCoursesByStartDate(IRequest currentDate) {
		...
		ResponseBuilder responseBuilder = new ResponseBuilder();
		try {
			return responseBuilder.build(mCoursesService.getCurrentCoursesWithLector(requestExtractor.extractDate(),
					SortColumnCourse.START_DATE), Messages.LIST_IS_EMPTY);
		} catch (ParseException e) {
			logger.error(e.getMessage());
		}
